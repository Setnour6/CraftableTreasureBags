...
namespace CraftableTreasureBags
{
	public class CraftableTreasureBags : Mod
	{
		...
		public override void AddRecipes()
		{
			...
			CreateRecipe(3319).AddIngredient<Items.EmptyTreasureBag>().AddRecipeGroup("CraftableTreasureBags:Gold/Platinum Pendant").AddIngredient(ItemID.SuspiciousLookingEye, 1).AddIngredient(ItemID.BlackLens, 1).AddIngredient(ItemID.DemoniteOre, 90).AddIngredient(ItemID.Deathweed, 3).AddIngredient(ItemID.EyeMask, 1).AddTile(26).Register(); //EOC (corruption)
			CreateRecipe(3319).AddIngredient<Items.EmptyTreasureBag>().AddRecipeGroup("CraftableTreasureBags:Gold/Platinum Pendant").AddIngredient(ItemID.SuspiciousLookingEye, 1).AddIngredient(ItemID.BlackLens, 1).AddIngredient(ItemID.CrimtaneOre, 90).AddIngredient(ItemID.Deathweed, 3).AddIngredient(ItemID.EyeMask, 1).AddTile(26).Register(); //EOC (crimson)
