...
{
	public class PlatinumFortressArtifact : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Not Equippable"
				...
				+ $"\n'This metallic box thing looks like it could sell for a fortune'");
			...
			Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Polish), "Nie mozna zalozyc"
				...
				+ $"\n'Te metaliczne pudelko wyglada na cos co mozna sprzedac za fortune'");
